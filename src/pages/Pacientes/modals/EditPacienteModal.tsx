        ...
        <div className="overflow-y-auto flex-1 min-h-0 px-8 py-4 scrollbar-violet">
          <div className="space-y-5">
            ...
            <div className="space-y-3 pt-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="edit-telefono" className="text-[14px] font-medium text-[#374151] font-['Inter'] flex items-center gap-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-email" className="text-[14px] font-medium text-[#374151] font-['Inter'] flex items-center gap-2">
