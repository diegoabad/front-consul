          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex gap-2">
              <Select value={estadoFilter} onValueChange={setEstadoFilter}>
                <SelectTrigger className="flex-1 h-12 border-[#D1D5DB] rounded-[10px] font-['Inter'] text-[15px] focus:border-[#7C3AED] focus:ring-[#7C3AED]/20">
                  <div className="flex items-center gap-2">
        ...
        <Card className="border border-[#E5E7EB] rounded-[16px] shadow-sm">
          <CardContent className="p-16 text-center">
            <div className="h-20 w-20 rounded-full bg-[#EDE9FE] flex items-center justify-center mx-auto mb-4">
              <Users className="h-10 w-10 text-[#7C3AED] stroke-[2]" />
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-[52px] border-[1.5px] border-[#D1D5DB] rounded-[10px] text-[16px] font-['Inter'] focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20 transition-all duration-200 pr-12"
                    placeholder="••••••••"
                  />
                  <Button
                    type="button"
                  ...
                  {showCreateEspecialidadInput ? (
                    <div className="flex gap-2">
                      <Input
                        ...
                        className="h-[52px] border-[1.5px] border-[#D1D5DB] rounded-[10px] font-['Inter'] text-[16px] focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20 transition-all duration-200"
                      ...
                      <Button
                        ...
                        className="h-[52px] px-4 rounded-[10px] bg-[#7C3AED] hover:bg-[#6D28D9] text-white font-medium font-['Inter'] disabled:opacity-50"
                      >
        ...
        <DialogContent className="max-w-md rounded-[20px] border border-[#E5E7EB] shadow-2xl gap-0 p-6">
          <DialogHeader className="mb-3 pb-0 border-b-0">
            ...
            <DialogDescription className="text-base text-[#6B7280] font-['Inter'] mt-2 mb-0">
              ¿Estás seguro de que deseas eliminar a <span className="font-semibold text-[#374151]">{selectedUsuario?.nombre} {selectedUsuario?.apellido}</span>? Esta acción no se puede deshacer.
            </DialogDescription>
          </DialogHeader>
