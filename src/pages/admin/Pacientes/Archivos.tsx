...
function getFileColor(tipo?: string) {
  ...
  if (tipo.startsWith('image/')) return 'text-[#7C3AED]';
        ...
        <Card className="border border-[#E5E7EB] rounded-[16px] shadow-sm">
          <CardContent className="p-16 text-center">
            <div className="h-20 w-20 rounded-full bg-[#EDE9FE] flex items-center justify-center mx-auto mb-4">
              <Paperclip className="h-10 w-10 text-[#7C3AED] stroke-[2]" />
            </div>
              ...
              <CardContent className="p-4">
                ...
                <div className="mb-3">
                  {isImage(archivo.tipo_archivo) ? (
                    ...
                    <div className="w-full h-32 rounded-[10px] bg-gradient-to-br from-[#EDE9FE] to-[#DDD6FE] flex items-center justify-center">
