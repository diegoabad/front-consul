...
export default function AdminPagos() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeMainTab} onValueChange={(v) => setActiveMainTab(v as 'contrato' | 'pagos')} className="space-y-6">
        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-[12px] p-1.5 inline-flex">
          <TabsList className="bg-transparent p-0 h-auto gap-1">
            <TabsTrigger value="pagos" className="rounded-[10px] px-5 py-2.5 text-[14px] font-medium font-['Inter'] text-[#6B7280] hover:text-[#374151] data-[state=active]:bg-[#7C3AED] data-[state=active]:text-white data-[state=active]:[&_svg]:text-white data-[state=active]:shadow-sm transition-all duration-200">
              <CreditCard className="h-4 w-4 mr-2 stroke-[2]" />
              Órdenes de pago
            </TabsTrigger>
            <TabsTrigger value="contrato" className="rounded-[10px] px-5 py-2.5 text-[14px] font-medium font-['Inter'] text-[#6B7280] hover:text-[#374151] data-[state=active]:bg-[#7C3AED] data-[state=active]:text-white data-[state=active]:[&_svg]:text-white data-[state=active]:shadow-sm transition-all duration-200">
            ...
            <Card className="border border-[#E5E7EB] rounded-[16px] shadow-sm">
              <CardContent className="p-16 text-center">
                <div className="h-20 w-20 rounded-full bg-[#EDE9FE] flex items-center justify-center mx-auto mb-4">
                  <FileText className="h-10 w-10 text-[#7C3AED] stroke-[2]" />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
                <div className="space-y-2">
                  ...
                  <Select value={filterProfesionalId} onValueChange={setFilterProfesionalId}>
                    <SelectTrigger className="h-12 w-full border-[1.5px] border-[#D1D5DB] rounded-[10px] font-['Inter'] text-[16px] focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20 transition-all duration-200">
        ...
        <DialogContent className="max-w-[700px] rounded-[20px] p-0 border border-[#E5E7EB] shadow-2xl flex flex-col max-h-[90vh]">
          <DialogHeader className="px-8 pt-8 pb-6 mb-0 border-b border-[#E5E7EB] bg-gradient-to-b from-white to-[#F9FAFB] flex-shrink-0 [&>div]:m-0">
            <div className="flex items-center gap-4 m-0">
              <div className="h-12 w-12 rounded-full bg-gradient-to-br from-[#7C3AED] to-[#6D28D9] flex items-center justify-center shadow-lg shadow-[#7C3AED]/20 flex-shrink-0">
        ...
        <DialogContent className="max-w-[640px] rounded-[20px] p-0 border border-[#E5E7EB] shadow-2xl">
          ...
          <div className="px-8 py-6 space-y-5">
            <div className="space-y-3">
              ...
              <Input
                ...
                className="h-[52px] border-[1.5px] border-[#D1D5DB] rounded-[10px] text-[16px] font-['Inter'] focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20 transition-all duration-200"
              />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-3">
                <Label htmlFor="edit-contrato-monto" className="text-[15px] font-medium text-[#374151] font-['Inter']">
                  Monto
                </Label>
                <Input
                  ...
                  onFocus={() => {
                    const n = parseValorToNumber(editContratoForm.monto_mensual);
                    if (n !== undefined) setEditContratoForm((f) => ({ ...f, monto_mensual: String(n) }));
                  }}
                  placeholder="$ 0"
              ...
              <div className="space-y-3">
                ...
                >
                  <SelectTrigger className="h-[52px] border-[1.5px] border-[#D1D5DB] rounded-[10px] text-[16px] font-['Inter'] focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20 transition-all duration-200">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="rounded-[12px] border-[#E5E7EB] shadow-xl">
          ...
          <DialogFooter className="px-8 py-5 mt-0 border-t border-[#E5E7EB] bg-[#F9FAFB] flex flex-row justify-end items-center gap-3 [&>div]:m-0">
            ...
            <Button
              ...
              className="h-[48px] px-8 rounded-[12px] bg-[#7C3AED] hover:bg-[#6D28D9] text-white shadow-lg shadow-[#7C3AED]/30 hover:shadow-xl hover:shadow-[#7C3AED]/40 font-semibold font-['Inter'] text-[15px] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
                ...
                return (
                  <button
                    ...
                    className={`h-9 rounded-[10px] text-[13px] font-medium font-['Inter'] transition-all
                      ...
                      ${!isSelected && isCurrentMonth ? 'text-[#374151] hover:bg-[#EDE9FE] cursor-pointer' : ''}`}
                  >
                    {format(day, 'd')}
                  </button>
                );
      ...
      {/* Confirmar eliminar contrato */}
      <Dialog open={showEliminarContratoConfirm} onOpenChange={setShowEliminarContratoConfirm}>
        <DialogContent className="max-w-md rounded-[20px] border border-[#E5E7EB] shadow-2xl gap-0 p-6">
          <DialogHeader className="mb-3 pb-0 border-b-0">
            ...
            <DialogDescription className="text-base text-[#6B7280] font-['Inter'] mt-2 mb-0">
              ¿Estás seguro de que deseas quitar el contrato de <span className="font-semibold text-[#374151]">{contratoToEliminar ? `${contratoToEliminar.nombre} ${contratoToEliminar.apellido}` : ''}</span>? Se borrarán la fecha de inicio y el monto mensual.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="flex flex-row justify-end gap-3 mt-4 pt-4 border-t border-[#E5E7EB]">
            <Button
              variant="outline"
              onClick={() => { setShowEliminarContratoConfirm(false); setContratoToEliminar(null); }}
            ...
            <Button
              variant="destructive"
              onClick={handleConfirmEliminarContrato}
              disabled={eliminarContratoMutation.isPending}
              className="h-[48px] px-8 rounded-[12px] font-semibold font-['Inter'] text-[15px]"
            >
              {eliminarContratoMutation.isPending ? (
                <>
                  <Loader2 className="mr-2 h-5 w-5 animate-spin stroke-[2.5]" />
                  Eliminando...
                </>
      ...
      {/* Confirmar eliminar orden de pago */}
      <Dialog open={showDeletePagoConfirm} onOpenChange={setShowDeletePagoConfirm}>
        <DialogContent className="max-w-md rounded-[20px] border border-[#E5E7EB] shadow-2xl gap-0 p-6">
          <DialogHeader className="mb-3 pb-0 border-b-0">
            ...
            <DialogDescription className="text-base text-[#6B7280] font-['Inter'] mt-2 mb-0">
              ¿Estás seguro de que deseas eliminar la orden de <span className="font-semibold text-[#374151]">{pagoToDelete ? `${pagoToDelete.profesional_nombre} ${pagoToDelete.profesional_apellido} — ${formatPeriodoDisplay(pagoToDelete)}` : ''}</span>? Esta acción no se puede deshacer.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="flex flex-row justify-end gap-3 mt-4 pt-4 border-t border-[#E5E7EB]">
            <Button
              variant="outline"
              onClick={() => { setShowDeletePagoConfirm(false); setPagoToDelete(null); }}
              className="h-[48px] px-6 rounded-[12px] font-medium font-['Inter'] text-[15px]"
            >
              Cancelar
            </Button>
  ...
  if (pagos.length === 0) {
    return (
      <Card className="border border-[#E5E7EB] rounded-[16px] shadow-sm">
        <CardContent className="p-16 text-center">
          <div className="h-20 w-20 rounded-full bg-[#EDE9FE] flex items-center justify-center mx-auto mb-4">
            <DollarSign className="h-10 w-10 text-[#7C3AED] stroke-[2]" />
          </div>
