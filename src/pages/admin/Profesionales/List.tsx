          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Select value={estadoFilter} onValueChange={setEstadoFilter}>
                <SelectTrigger className="h-12 border-[#D1D5DB] rounded-[10px] text-[16px] font-['Inter'] focus:border-[#7C3AED] focus:ring-[#7C3AED]/20 transition-all duration-200">
        ...
        <Card className="border border-[#E5E7EB] rounded-[16px] shadow-sm">
          <CardContent className="p-16 text-center">
            <div className="h-20 w-20 rounded-full bg-[#EDE9FE] flex items-center justify-center mx-auto mb-4">
              <Stethoscope className="h-10 w-10 text-[#7C3AED] stroke-[2]" />
            </div>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              variant="ghost"
                              size="icon"
                              onClick={() => navigate(`/admin/agendas?profesional=${prof.id}`)}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Textarea
                  ...
                  className="min-h-[120px] border-[1.5px] border-[#D1D5DB] rounded-[10px] font-['Inter'] text-[16px] focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20 transition-all duration-200 resize-none"
                />
              </div>
            </div>
          </div>
      ...
      <Dialog open={showDeleteModal} onOpenChange={setShowDeleteModal}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ¿Está seguro de que desea eliminar a {profesionalToDelete?.nombre} {profesionalToDelete?.apellido}? Esta acción no se puede deshacer.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
