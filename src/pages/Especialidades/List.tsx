  ...
  return (
    <div className="space-y-8">
                  ...
                  <TableCell className="py-4">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-full bg-gradient-to-br from-[#2563eb]/10 to-[#1d4ed8]/10 flex items-center justify-center">
                        <GraduationCap className="h-5 w-5 text-[#2563eb] stroke-[2]" />
                      </div>
      ...
      <ConfirmDeleteModal
        ...
        description={<>¿Estás seguro de que deseas eliminar la especialidad <span className="font-semibold text-[#374151]">&quot;{selected?.nombre}&quot;</span>? Esta acción no se puede deshacer.</>}
